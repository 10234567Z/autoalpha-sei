"""
HTTP-based Sei Network Analyzer MCP Server
Streamable HTTP version for cloud deployment
"""
...
# Create server instance with HTTP transport
...
if __name__ == "__main__":
    ...
    mcp.run(transport="httpx", port=port, host="0.0.0.0")
